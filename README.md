# ImGuiRedux
[Dear ImGui](https://github.com/ocornut/imgui) bindings for [CLEORedux](https://re.cleo.li/). Check out the example script [here](https://github.com/player001-hack/ImGuiRedux/blob/master/resource/imgui_test.js) & download binaries from [here](https://github.com/player001-hack/ImGuiRedux/releases)
...
### Installation 
1. Install [ASI Loader](https://github.com/ThirteenAG/Ultimate-ASI-Loader/releases) & [ImGuiRedux x86](https://github.com/player001-hack/ImGuiRedux/releases/tag/Win32-latest)
...
1. D3D8 (with [wrapper](https://github.com/player001-hack/ImGuiRedux/blob/master/resource/d3d8.dll)) 
2. D3D9
3. D3D11
4. OpenGL3 (Soon)

### Installation 
1. Install your required version of [ASI Loader](https://github.com/ThirteenAG/Ultimate-ASI-Loader/releases) & [ImGuiRedux](https://github.com/player001-hack/ImGuiRedux/releases/) (x86 or x64)
